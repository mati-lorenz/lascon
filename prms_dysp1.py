...
#simConfig.recordSpikesGids = [-1]
simConfig.recordStep = 0.1 # Step size in ms to save data (eg. V traces, LFP, etc)

# Saving
simConfig.filename = './data/M1_dysp1'  # Set file output name
...
#simConfig.saveDpk = True # save to .dpk pickled file
#simConfig.saveHDF5 = True# save to HDF5 file 
...
netParams.popParams['IT_L5B'] = {'cellModel': 'Izhi', 'cellType': 'IT',  'ynormRange': [0.52, 0.77], 'density': 20e3} #  L5B IT

netParams.popParams['PT_L5B'] = {'cellModel': 'Izhi', 'cellType': 'PT',  'ynormRange': [0.31, 0.77], 'density': 20e3} #  L5B PT
...
netParams.popParams['PV_L5'] =  {'cellModel': 'Izhi', 'cellType': 'PV',  'ynormRange': [0.31, 1.], 'density': 15e3} #  L5 PV (FS)

netParams.popParams['SOM_L5'] = {'cellModel': 'Izhi', 'cellType': 'SOM', 'ynormRange': [0.31, 0.77], 'density': 5e3} #  L5 SOM (LTS)
